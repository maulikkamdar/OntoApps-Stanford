...
// Reference: A. Bondi, J. Phys. Chem., 1964, 68, 441.
   ...
   var self = this;
   jQuery(window).resize(function() { // only window can capture resize event
...
GLmol.prototype.enableMouse = function() {
   var me = this, glDOM = jQuery(this.renderer.domElement);
   ...
   glDOM.bind('mousemove touchmove', function(ev) { // touchmove
      ...
      var mode = 0;
      var modeRadio = jQuery('input[name=' + me.id + '_mouseMode]:checked');
